...
public class UsersPage extends TestBase  {
    ...
    public void clickOnNewUserButton() {
        ...
        lastName = wait.until(ExpectedConditions.elementToBeClickable(lastName));
    ...
    public void fillUserData(UserCredential userCredential) {
        firstName.sendKeys(userCredential.getFirstName());
        lastName.sendKeys(userCredential.getLastName());
        email.sendKeys(userCredential.getEmail());
    }
